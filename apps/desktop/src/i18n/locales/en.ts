...
export default {
  ...
  auth: {
    ...
    ldapAllowedGroups: "Allowed groups",
    ldapAllowedGroupsPlaceholder: "CN=DBA,OU=Groups,DC=corp,DC=com, dba-admins",
    ldapAllowedGroupsHint: "Comma-separated group DNs or names (escape commas inside a DN as \\,). Leave empty to allow everyone; when set, only members may log in.",
    ldapTest: "Test",
  ...
  ldap: {
    ...
    verifyPasswordTooltip: "Verify password (one-off bind)",
    verifyPasswordPlaceholder: "Type a password to verify",
    passwordVerified: "Password verified",
    passwordNotVerified: "Password is not correct",
    binaryReadonlyHint: "Binary value (base64) — read-only in this editor",
    showOperational: "Toggle operational attributes (createTimestamp, entryUUID, …)",
    objectClassEditorTitle: "Edit object classes",
    ...
    editTitle: "Edit LDAP Entry",
    renameTitle: "Rename LDAP Entry",
    currentDn: "Current DN",
    newRdn: "New RDN",
    newParentDn: "New parent DN",
    newParentDnHint: "optional, leave empty to keep the current parent",
    deleteTitle: "Delete LDAP Entry",
