...
export default withEnglishFallback({
  ...
  auth: {
    ...
    ldapLogin: "Accedi con LDAP",
    ldapLoginFailed: "Credenziali LDAP non valide",
    ldapUsernameLabel: "Nome utente",
    ldapUsernamePlaceholder: "es. alice o alice@corp.example.com",
    copyLdapsearchTooltip: "Copia questa voce come comando ldapsearch",
    copyGetAdObjectTooltip: "Copia questa voce come comando PowerShell Get-ADObject",
    usePassword: "Accedi con password",
    ldapSettingsTitle: "Accesso LDAP",
    ldapSettingsDescription: "Consenti agli utenti di accedere con account LDAP / Active Directory invece di (o in additione a) la password dell'istanza.",
    ldapEnabled: "Abilita accesso LDAP",
    ldapProviderName: "Nome del provider",
    ldapProviderNamePlaceholder: "es. Active Directory aziendale",
    ldapHost: "Server",
    ldapHostPlaceholder: "ldap.example.com",
    ldapPort: "Porta",
    ldapBaseDn: "DN base",
    ldapBaseDnPlaceholder: "DC=corp,DC=example,DC=com",
    ldapUseTls: "Usa TLS (ldaps://)",
    ldapRequireServiceAccount: "Usa account di servizio",
    ldapRequireServiceAccountHint: "Abilitare quando gli utenti non possono eseguire il bind direttamente (ambienti non AD). Un account di servizio cerca prima il DN dell'utente, quindi esegue il bind con la password dell'utente.",
    ldapServiceAccountDn: "DN dell'account di servizio",
    ldapServiceAccountDnPlaceholder: "CN=svc,OU=Service,DC=corp,DC=com",
    ldapServiceAccountPassword: "Password dell'account di servizio",
    ldapServiceAccountPasswordSet: "Password dell'account di servizio salvata. Lasciare vuoto per mantenere il valore attuale.",
    ldapSearchBase: "Base di ricerca",
    ldapSearchBasePlaceholder: "Usa il DN base quando vuoto",
    ldapSearchFilter: "Filtro di ricerca",
    ldapSearchFilterPlaceholder: "(|(sAMAccountName={user})(userPrincipalName={user})(mail={user})(cn={user}))",
    ldapAllowedGroups: "Gruppi consentiti",
    ldapAllowedGroupsPlaceholder: "CN=DBA,OU=Groups,DC=corp,DC=com, dba-admins",
    ldapAllowedGroupsHint: "DN o nomi di gruppo separati da virgole (usa \\, per le virgole in un DN). Lascia vuoto per consentire a tutti; se impostato, possono accedere solo i membri.",
    ldapTest: "Testa",
    ldapSave: "Salva accesso LDAP",
    ldapTestSuccess: "Test di connessione riuscito",
    ldapTestFailed: "Test di connessione non riuscito",
    ldapSaveSuccess: "Configurazione accesso LDAP salvata",
    ldapSaveFailed: "Impossibile salvare la configurazione accesso LDAP",
    ldapLoadFailed: "Impossibile caricare la configurazione accesso LDAP",
  },
  toolbar: {
  ...
  connection: {
    ...
    ldapSecurityProtocol: "Autenticazione",
    ldapSimple: "Bind semplice",
    ldapGssapi: "GSSAPI (Kerberos)",
    ldapNone: "Nessuno",
    ldapPrincipal: "Principal",
    ldapKeytabFile: "File Keytab",
    ldapKeytabSelected: "File Keytab selezionato. La password verrà usata come fallback.",
    ldapPasswordOptional: "Password (opzionale con Keytab)",
    ldapPasswordRequired: "Password",
    ldapKrb5Conf: "krb5.conf",
    ldapKrb5ConfPlaceholder: "[libdefaults]\n    default_realm = EXAMPLE.COM\n\n[realms]\n    EXAMPLE.COM = {\n        kdc = kdc.example.com:88\n    }",
    ldapKrb5ConfHint: "Configurazione Kerberos in formato krb5.conf. Richiesta per GSSAPI.",
    ldapSearchFilter: "Filtro di ricerca",
    principal: "Principal Kerberos",
    keytab: "File Keytab",
    browse: "Sfoglia",
    passwordOptionalForKeytab: "Password (opzionale, lasciare vuoto per autenticazione solo con Keytab)",
    passwordRequired: "Password (obbligatoria)",
    krb5Conf: "krb5.conf",
    krb5ConfPlaceholder: "[libdefaults]\n    default_realm = EXAMPLE.COM\n\n[realms]\n    EXAMPLE.COM = {\n        kdc = kdc.example.com:88\n    }",
    krb5ConfHint: "Incolla qui il contenuto di krb5.conf. Verrà usato come file temporaneo per questa connessione.",
  ...
  editor: {
    ...
    contextMenu: {
      ...
      openLdapBrowser: "Sfoglia directory LDAP",
      openLdapSearch: "Cerca in LDAP",
    },
    search: {
      find: "Trova",
      replace: "Sostituisci",
  ...
  ldap: {
    copyLdapsearchTooltip: "Copia come comando ldapsearch",
    copyGetAdObjectTooltip: "Copia come comando PowerShell Get-ADObject",
    addEntry: "Aggiungi voce",
    openInBrowser: "Apri nel browser",
    missingMustHint: "Attributo obbligatorio mancante; digita un valore per aggiungerlo",
    verifyPasswordTooltip: "Verifica password (bind singolo)",
    verifyPasswordPlaceholder: "Digita una password da verificare",
    passwordVerified: "Password verificata",
    passwordNotVerified: "Password non corretta",
    binaryReadonlyHint: "Valore binario (base64); questo editor non lo modifica ancora",
    showOperational: "Attiva/disattiva attributi operativi (createTimestamp, entryUUID, …)",
    objectClassEditorTitle: "Modifica classi di oggetti",
    ...
    editTitle: "Modifica voce LDAP",
    renameTitle: "Rinomina voce LDAP",
    currentDn: "DN attuale",
    newRdn: "Nuovo RDN",
    newParentDn: "Nuovo DN padre",
    newParentDnHint: "opzionale; lascia vuoto per mantenere il padre attuale",
    deleteTitle: "Elimina voce LDAP",
  ...
  settings: {
    ...
    mcpToolExecuteLdapSearch: "Esegui ricerca LDAP",
