...
export default withEnglishFallback({
  ...
  auth: {
    ...
    ldapLoginFailed: "LDAP 认证失败",
    ldapUsernameLabel: "用户名",
    ldapUsernamePlaceholder: "例如 alice 或 alice{'@'}corp.example.com",
    copyLdapsearchTooltip: "将此条目复制为 ldapsearch 命令",
    copyGetAdObjectTooltip: "将此条目复制为 PowerShell Get-ADObject 命令",
    usePassword: "使用密码登录",
    ldapSettingsTitle: "LDAP 登录",
    ldapSettingsDescription: "允许用户使用 LDAP / Active Directory 账户登录，替代（或补充）实例密码。",
    ldapEnabled: "启用 LDAP 登录",
    ldapProviderName: "提供商名称",
    ldapProviderNamePlaceholder: "例如 企业 Active Directory",
    ldapHost: "服务器",
    ...
    ldapRequireServiceAccount: "使用服务账户",
    ldapRequireServiceAccountHint: "当用户无法直接绑定时启用（非 AD 环境）。先用服务账户查询用户 DN，再用用户密码重新绑定。",
    ldapServiceAccountDn: "服务账户 DN",
    ldapServiceAccountDnPlaceholder: "CN=svc,OU=Service,DC=corp,DC=com",
    ldapServiceAccountPassword: "服务账户密码",
    ldapServiceAccountPasswordSet: "已保存服务账户密码，留空表示保持不变。",
    ldapSearchBase: "搜索基准",
    ldapSearchBasePlaceholder: "留空时使用基准 DN",
    ldapSearchFilter: "搜索过滤器",
    ldapSearchFilterPlaceholder: "({'|'}(sAMAccountName={'{'}user{'}'})(userPrincipalName={'{'}user{'}'})(mail={'{'}user{'}'})(cn={'{'}user{'}'}))",
    ldapAllowedGroups: "允许登录的组",
    ldapAllowedGroupsPlaceholder: "CN=DBA,OU=Groups,DC=corp,DC=com, dba-admins",
    ldapAllowedGroupsHint: "逗号分隔的组 DN 或组名(DN 内逗号需写成 \\,)。留空不限制;设置后仅组成员可登录。",
    ldapTest: "测试",
    ldapSave: "保存 LDAP 登录",
    ldapTestSuccess: "连接测试成功",
    ldapTestFailed: "连接测试失败",
    ldapSaveSuccess: "LDAP 登录配置已保存",
    ldapSaveFailed: "保存 LDAP 登录配置失败",
    ldapLoadFailed: "加载 LDAP 登录配置失败",
  },
  toolbar: {
    moreActions: "更多操作",
    newConnection: "新建连接",
  ...
  connection: {
    ...
    ldapBaseDn: "基准 DN",
    authMethod: "认证方式",
    ldapSecurityProtocol: "认证",
    ldapSimple: "简单绑定",
    ldapGssapi: "GSSAPI (Kerberos)",
    ldapNone: "无",
    ldapPrincipal: "Principal",
    ldapKeytabFile: "Keytab 文件",
    ldapKeytabSelected: "已选择 Keytab 文件，密码将用作备用。",
    ldapPasswordOptional: "密码（使用 Keytab 时可选）",
    ldapPasswordRequired: "密码",
    ldapKrb5Conf: "krb5.conf",
    ldapKrb5ConfPlaceholder: "[libdefaults]\n    default_realm = EXAMPLE.COM\n\n[realms]\n    EXAMPLE.COM = {\n        kdc = kdc.example.com:88\n    }",
    ldapKrb5ConfHint: "krb5.conf 格式的 Kerberos 配置。使用 GSSAPI 时必填。",
    ldapSearchFilter: "搜索过滤器",
    principal: "Kerberos Principal",
    keytab: "Keytab 文件",
    browse: "浏览",
    passwordOptionalForKeytab: "密码（可选，仅用 Keytab 认证时留空）",
    passwordRequired: "密码（必填）",
    krb5Conf: "krb5.conf",
    krb5ConfPlaceholder: "[libdefaults]\n    default_realm = EXAMPLE.COM\n\n[realms]\n    EXAMPLE.COM = {\n        kdc = kdc.example.com:88\n    }",
    krb5ConfHint: "在此粘贴 krb5.conf 内容，将作为临时文件供本次连接使用。",
  ...
  contextMenu: {
    ...
    name: "名称",
    fullPath: "完整路径",
    openLdapBrowser: "浏览 LDAP 目录",
    openLdapSearch: "搜索 LDAP",
  ...
  ldap: {
    ...
    verifyPasswordTooltip: "验证密码(一次性 bind)",
    verifyPasswordPlaceholder: "输入要验证的密码",
    passwordVerified: "密码验证通过",
    passwordNotVerified: "密码不正确",
    binaryReadonlyHint: "二进制值(base64),此编辑器暂不支持修改",
    showOperational: "切换 operational 属性(createTimestamp、entryUUID 等)",
    objectClassEditorTitle: "编辑对象类",
    ...
    removeValue: "删除值",
    editTitle: "编辑 LDAP 条目",
    renameTitle: "重命名 LDAP 条目",
    currentDn: "当前 DN",
    newRdn: "新 RDN",
    newParentDn: "新父 DN",
    newParentDnHint: "可选,留空保持原父级",
    deleteTitle: "删除 LDAP 条目",
  ...
  settings: {
    ...
    mcpToolExecuteLdapSearch: "执行 LDAP 搜索",
