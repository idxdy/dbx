...
export default withEnglishFallback({
  ...
  auth: {
    ...
    ldapLoginFailed: "LDAP 認証に失敗しました",
    ldapUsernameLabel: "ユーザー名",
    ldapUsernamePlaceholder: "例: alice または alice@corp.example.com",
    copyLdapsearchTooltip: "このエントリを ldapsearch コマンドとしてコピー",
    copyGetAdObjectTooltip: "このエントリを PowerShell Get-ADObject コマンドとしてコピー",
    usePassword: "パスワードでログイン",
    ldapSettingsTitle: "LDAP ログイン",
    ldapSettingsDescription: "LDAP / Active Directory アカウントでログインできるようにします（インスタンスパスワードの代わりに、または併用して使用できます）。",
    ldapEnabled: "LDAP ログインを有効にする",
    ldapProviderName: "プロバイダー名",
    ldapProviderNamePlaceholder: "例: 企業の Active Directory",
    ldapHost: "サーバー",
    ldapHostPlaceholder: "ldap.example.com",
    ldapPort: "ポート",
    ldapBaseDn: "ベース DN",
    ldapBaseDnPlaceholder: "DC=corp,DC=example,DC=com",
    ldapUseTls: "TLS を使用 (ldaps://)",
    ldapRequireServiceAccount: "サービスアカウントを使用",
    ldapRequireServiceAccountHint: "ユーザーが直接バインドできない場合に有効にします（AD 環境外）。サービスアカウントがまずユーザー DN を検索し、その後ユーザーパスワードで再バインドします。",
    ldapServiceAccountDn: "サービスアカウント DN",
    ldapServiceAccountDnPlaceholder: "CN=svc,OU=Service,DC=corp,DC=com",
    ldapServiceAccountPassword: "サービスアカウントのパスワード",
    ldapServiceAccountPasswordSet: "サービスアカウントのパスワードが保存されました。空のままにすると現在の値が維持されます。",
    ldapSearchBase: "検索ベース",
    ldapSearchBasePlaceholder: "空の場合、ベース DN を使用",
    ldapSearchFilter: "検索フィルター",
    ldapSearchFilterPlaceholder: "(|(sAMAccountName={user})(userPrincipalName={user})(mail={user})(cn={user}))",
    ldapAllowedGroups: "許可グループ",
    ldapAllowedGroupsPlaceholder: "CN=DBA,OU=Groups,DC=corp,DC=com, dba-admins",
    ldapAllowedGroupsHint: "カンマ区切りのグループ DN または名前(DN 内のカンマは \\, とエスケープ)。空欄なら全員に許可。設定するとメンバーのみログイン可能です。",
    ldapTest: "テスト",
    ldapSave: "LDAP ログインを保存",
    ldapTestSuccess: "接続テストに成功しました",
    ldapTestFailed: "接続テストに失敗しました",
    ldapSaveSuccess: "LDAP ログイン設定を保存しました",
    ldapSaveFailed: "LDAP ログイン設定の保存に失敗しました",
    ldapLoadFailed: "LDAP ログイン設定の読み込みに失敗しました",
  },
  toolbar: {
    moreActions: "その他の操作",
    newConnection: "新しい接続",
  ...
  connection: {
    ...
    ldapBaseDn: "ベース DN",
    authMethod: "認証方式",
    ldapSecurityProtocol: "認証",
    ldapSimple: "シンプルバインド",
    ldapGssapi: "GSSAPI (Kerberos)",
    ldapNone: "なし",
    ldapPrincipal: "Principal",
    ldapKeytabFile: "Keytab ファイル",
    ldapKeytabSelected: "Keytab ファイルが選択されました。パスワードはフォールバックとして使用されます。",
    ldapPasswordOptional: "パスワード（Keytab 使用時は省略可能）",
    ldapPasswordRequired: "パスワード",
    ldapKrb5Conf: "krb5.conf",
    ldapKrb5ConfPlaceholder: "[libdefaults]\n    default_realm = EXAMPLE.COM\n\n[realms]\n    EXAMPLE.COM = {\n        kdc = kdc.example.com:88\n    }",
    ldapKrb5ConfHint: "krb5.conf 形式の Kerberos 設定。GSSAPI 使用時に必須です。",
    ldapSearchFilter: "検索フィルター",
    principal: "Kerberos Principal",
    keytab: "Keytab ファイル",
    browse: "参照",
    passwordOptionalForKeytab: "パスワード（省略可能、Keytab のみで認証する場合は空のまま）",
    passwordRequired: "パスワード（必須）",
    krb5Conf: "krb5.conf",
    krb5ConfPlaceholder: "[libdefaults]\n    default_realm = EXAMPLE.COM\n\n[realms]\n    EXAMPLE.COM = {\n        kdc = kdc.example.com:88\n    }",
    krb5ConfHint: "krb5.conf の内容をここに貼り付けてください。この接続の一時ファイルとして使用されます。",
  ...
  editor: {
    ...
    contextMenu: {
      ...
      openLdapBrowser: "LDAP ディレクトリを参照",
      openLdapSearch: "LDAP を検索",
    },
    search: {
      find: "検索",
      replace: "置換",
  ...
  ldap: {
    ...
    verifyPasswordTooltip: "パスワード検証(単発 bind)",
    verifyPasswordPlaceholder: "検証するパスワードを入力",
    passwordVerified: "パスワードを検証しました",
    passwordNotVerified: "パスワードが正しくありません",
    binaryReadonlyHint: "バイナリ値(base64)— このエディタでは編集できません",
    showOperational: "操作属性の表示を切り替え(createTimestamp、entryUUID など)",
    objectClassEditorTitle: "オブジェクトクラスを編集",
    ...
    removeValue: "値を削除",
    editTitle: "LDAP エントリを編集",
    renameTitle: "LDAP エントリの名前変更",
    currentDn: "現在の DN",
    newRdn: "新しい RDN",
    newParentDn: "新しい親 DN",
    newParentDnHint: "省略可。空欄の場合は現在の親を維持",
    deleteTitle: "LDAP エントリを削除",
