...
export default withEnglishFallback({
  ...
  auth: {
    ...
    ldapLogin: "Iniciar sesión con LDAP",
    ldapLoginFailed: "Credenciales LDAP no válidas",
    ldapUsernameLabel: "Nombre de usuario",
    ldapUsernamePlaceholder: "p. ej. alice o alice@corp.example.com",
    ...
    ldapSettingsTitle: "Inicio de sesión LDAP",
    ldapSettingsDescription: "Permitir a los usuarios iniciar sesión con cuentas LDAP / Active Directory en lugar de (o además de) la contraseña de la instancia.",
    ldapEnabled: "Habilitar inicio de sesión LDAP",
    ldapProviderName: "Nombre del proveedor",
    ldapProviderNamePlaceholder: "p. ej. Active Directory corporativo",
    ldapHost: "Servidor",
    ...
    ldapRequireServiceAccount: "Usar cuenta de servicio",
    ldapRequireServiceAccountHint: "Activar cuando los usuarios no pueden vincularse directamente (entornos que no son AD). Una cuenta de servicio busca el DN del usuario primero y luego se vincula con la contraseña del usuario.",
    ldapServiceAccountDn: "DN de la cuenta de servicio",
    ldapServiceAccountDnPlaceholder: "CN=svc,OU=Service,DC=corp,DC=com",
    ldapServiceAccountPassword: "Contraseña de la cuenta de servicio",
    ldapServiceAccountPasswordSet: "Contraseña de la cuenta de servicio guardada. Dejar vacío para mantener el valor actual.",
    ldapSearchBase: "Base de búsqueda",
    ldapSearchBasePlaceholder: "Usa el DN base cuando está vacío",
    ldapSearchFilter: "Filtro de búsqueda",
    ...
    ldapAllowedGroupsHint: "DN o nombres de grupo separados por comas (escapa las comas de un DN como \\,). Déjelo vacío para permitir a todos; si se establece, solo podrán iniciar sesión los miembros.",
    ldapTest: "Probar",
    ldapSave: "Guardar inicio de sesión LDAP",
    ldapTestSuccess: "Prueba de conexión exitosa",
    ldapTestFailed: "Prueba de conexión fallida",
    ldapSaveSuccess: "Configuración de inicio de sesión LDAP guardada",
    ldapSaveFailed: "Error al guardar la configuración de inicio de sesión LDAP",
    ldapLoadFailed: "Error al cargar la configuración de inicio de sesión LDAP",
  },
  toolbar: {
  ...
  connection: {
    ...
    ldapSecurityProtocol: "Autenticación",
    ldapSimple: "Enlace simple",
    ldapGssapi: "GSSAPI (Kerberos)",
    ldapNone: "Ninguno",
    ldapPrincipal: "Principal",
    ldapKeytabFile: "Archivo Keytab",
    ldapKeytabSelected: "Archivo Keytab seleccionado. La contraseña se usará como respaldo.",
    ldapPasswordOptional: "Contraseña (opcional con Keytab)",
    ldapPasswordRequired: "Contraseña",
    ldapKrb5Conf: "krb5.conf",
    ldapKrb5ConfPlaceholder: "[libdefaults]\n    default_realm = EXAMPLE.COM\n\n[realms]\n    EXAMPLE.COM = {\n        kdc = kdc.example.com:88\n    }",
    ldapKrb5ConfHint: "Configuración de Kerberos en formato krb5.conf. Requerido para GSSAPI.",
    ldapSearchFilter: "Filtro de búsqueda",
    principal: "Principal de Kerberos",
    keytab: "Archivo Keytab",
    browse: "Examinar",
    passwordOptionalForKeytab: "Contraseña (opcional, dejar vacío para autenticación solo con Keytab)",
    passwordRequired: "Contraseña (obligatoria)",
    krb5Conf: "krb5.conf",
    krb5ConfPlaceholder: "[libdefaults]\n    default_realm = EXAMPLE.COM\n\n[realms]\n    EXAMPLE.COM = {\n        kdc = kdc.example.com:88\n    }",
    krb5ConfHint: "Pegue el contenido de krb5.conf aquí. Se usará como archivo temporal para esta conexión.",
  ...
  editor: {
    ...
    contextMenu: {
      ...
      openLdapBrowser: "Examinar directorio LDAP",
      openLdapSearch: "Buscar en LDAP",
    },
    search: {
      find: "Buscar",
      replace: "Reemplazar",
  ...
  ldap: {
    ...
    copyGetAdObjectTooltip: "Copiar como comando de PowerShell Get-ADObject",
    addEntry: "Añadir entrada",
    openInBrowser: "Abrir en el navegador",
    missingMustHint: "Falta un atributo obligatorio; escriba un valor para añadirlo",
    verifyPasswordTooltip: "Verificar contraseña (bind único)",
    verifyPasswordPlaceholder: "Escriba una contraseña para verificar",
    passwordVerified: "Contraseña verificada",
    passwordNotVerified: "La contraseña no es correcta",
    binaryReadonlyHint: "Valor binario (base64); este editor no permite modificarlo todavía",
    showOperational: "Alternar atributos operativos (createTimestamp, entryUUID, …)",
    objectClassEditorTitle: "Editar clases de objeto",
    ...
    createTitle: "Nueva entrada LDAP",
    parentDn: "DN padre",
    rdn: "RDN",
    ...
    renameTitle: "Renombrar entrada LDAP",
    currentDn: "DN actual",
    newRdn: "Nuevo RDN",
    newParentDn: "Nuevo DN padre",
    newParentDnHint: "opcional; dejar vacío para conservar el padre actual",
    deleteTitle: "Eliminar entrada LDAP",
    ...
    openDnTooltip: "Ir a esta entrada",
    save: "Guardar",
    create: "Crear",
    rename: "Renombrar",
    cancel: "Cancelar",
