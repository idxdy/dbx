...
export default withEnglishFallback({
  ...
  auth: {
    ...
    ldapLoginFailed: "Credenciais LDAP inválidas",
    ldapUsernameLabel: "Nome de usuário",
    ldapUsernamePlaceholder: "ex. alice ou alice@corp.example.com",
    copyLdapsearchTooltip: "Copiar esta entrada como comando ldapsearch",
    copyGetAdObjectTooltip: "Copiar esta entrada como comando PowerShell Get-ADObject",
    usePassword: "Entrar com senha",
    ldapSettingsTitle: "Login LDAP",
    ldapSettingsDescription: "Permitir que os usuários façam login com contas LDAP / Active Directory em vez de (ou além da) senha da instância.",
    ldapEnabled: "Habilitar login LDAP",
    ldapProviderName: "Nome do provedor",
    ldapProviderNamePlaceholder: "ex. Active Directory corporativo",
    ldapHost: "Servidor",
    ...
    ldapRequireServiceAccount: "Usar conta de serviço",
    ldapRequireServiceAccountHint: "Ativar quando os usuários não podem fazer bind diretamente (ambientes não AD). Uma conta de serviço primeiro busca o DN do usuário e depois faz bind com a senha do usuário.",
    ldapServiceAccountDn: "DN da conta de serviço",
    ldapServiceAccountDnPlaceholder: "CN=svc,OU=Service,DC=corp,DC=com",
    ldapServiceAccountPassword: "Senha da conta de serviço",
    ldapServiceAccountPasswordSet: "Senha da conta de serviço salva. Deixe vazio para manter o valor atual.",
    ldapSearchBase: "Base de pesquisa",
    ldapSearchBasePlaceholder: "Usa o DN base quando vazio",
    ldapSearchFilter: "Filtro de pesquisa",
    ldapSearchFilterPlaceholder: "(|(sAMAccountName={user})(userPrincipalName={user})(mail={user})(cn={user}))",
    ldapAllowedGroups: "Grupos permitidos",
    ldapAllowedGroupsPlaceholder: "CN=DBA,OU=Groups,DC=corp,DC=com, dba-admins",
    ldapAllowedGroupsHint: "DNs ou nomes de grupo separados por vírgulas (escape vírgulas de um DN como \\,). Deixe vazio para permitir todos; quando definido, somente membros poderão entrar.",
    ldapTest: "Testar",
    ldapSave: "Salvar login LDAP",
    ldapTestSuccess: "Teste de conexão bem-sucedido",
    ldapTestFailed: "Falha no teste de conexão",
    ldapSaveSuccess: "Configuração de login LDAP salva",
    ldapSaveFailed: "Falha ao salvar a configuração de login LDAP",
    ldapLoadFailed: "Falha ao carregar a configuração de login LDAP",
  },
  toolbar: {
  ...
  connection: {
    ...
    ldapSecurityProtocol: "Autenticação",
    ldapSimple: "Bind simples",
    ldapGssapi: "GSSAPI (Kerberos)",
    ldapNone: "Nenhum",
    ldapPrincipal: "Principal",
    ldapKeytabFile: "Arquivo Keytab",
    ldapKeytabSelected: "Arquivo Keytab selecionado. A senha será usada como fallback.",
    ldapPasswordOptional: "Senha (opcional com Keytab)",
    ldapPasswordRequired: "Senha",
    ldapKrb5Conf: "krb5.conf",
    ldapKrb5ConfPlaceholder: "[libdefaults]\n    default_realm = EXAMPLE.COM\n\n[realms]\n    EXAMPLE.COM = {\n        kdc = kdc.example.com:88\n    }",
    ldapKrb5ConfHint: "Configuração Kerberos no formato krb5.conf. Obrigatória para GSSAPI.",
    ldapSearchFilter: "Filtro de pesquisa",
    principal: "Principal Kerberos",
    keytab: "Arquivo Keytab",
    browse: "Procurar",
    passwordOptionalForKeytab: "Senha (opcional, deixe vazio para autenticação apenas com Keytab)",
    passwordRequired: "Senha (obrigatória)",
    krb5Conf: "krb5.conf",
    krb5ConfPlaceholder: "[libdefaults]\n    default_realm = EXAMPLE.COM\n\n[realms]\n    EXAMPLE.COM = {\n        kdc = kdc.example.com:88\n    }",
    krb5ConfHint: "Cole o conteúdo do krb5.conf aqui. Será usado como arquivo temporário para esta conexão.",
  ...
  editor: {
    ...
    contextMenu: {
      ...
      openLdapBrowser: "Procurar diretório LDAP",
      openLdapSearch: "Pesquisar LDAP",
    },
    search: {
      find: "Localizar",
      replace: "Substituir",
  ...
  ldap: {
    ...
    verifyPasswordTooltip: "Verificar senha (bind único)",
    verifyPasswordPlaceholder: "Digite uma senha para verificar",
    passwordVerified: "Senha verificada",
    passwordNotVerified: "Senha incorreta",
    binaryReadonlyHint: "Valor binário (base64) — este editor ainda não permite editá-lo",
    showOperational: "Alternar atributos operacionais (createTimestamp, entryUUID, …)",
    objectClassEditorTitle: "Editar classes de objeto",
    addAuxiliaryClass: "Adicionar classe auxiliar",
    removeClass: "Remover classe auxiliar",
    objectClassEditorHint: "Somente classes auxiliares podem ser adicionadas ou removidas; classes estruturais definem o tipo da entrada.",
    editEntry: "Editar",
    renameEntry: "Renomear",
    deleteEntry: "Excluir",
    addChildEntry: "Adicionar entrada filha",
    createTitle: "Nova entrada LDAP",
    parentDn: "DN pai",
    rdn: "RDN",
    ...
    editTitle: "Editar entrada LDAP",
    renameTitle: "Renomear entrada LDAP",
    currentDn: "DN atual",
    newRdn: "Novo RDN",
    newParentDn: "Novo DN pai",
    newParentDnHint: "opcional; deixe vazio para manter o pai atual",
    deleteTitle: "Excluir entrada LDAP",
    deleteConfirmMessage: "A entrada LDAP abaixo e todos os seus atributos serão excluídos permanentemente. Esta ação não pode ser desfeita.",
  ...
  settings: {
    ...
    mcpToolExecuteLdapSearch: "Executar busca LDAP",
