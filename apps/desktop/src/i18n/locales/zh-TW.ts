...
export default withEnglishFallback({
  ...
  auth: {
    ...
    ldapLogin: "使用 LDAP 登入",
    ldapLoginFailed: "LDAP 認證失敗",
    ldapUsernameLabel: "使用者名稱",
    ldapUsernamePlaceholder: "例如 alice 或 alice@corp.example.com",
    copyLdapsearchTooltip: "將此條目複製為 ldapsearch 指令",
    copyGetAdObjectTooltip: "將此條目複製為 PowerShell Get-ADObject 指令",
    usePassword: "使用密碼登入",
    ldapSettingsTitle: "LDAP 登入",
    ldapSettingsDescription: "允許使用者使用 LDAP / Active Directory 帳戶登入，取代（或搭配）實例密碼。",
    ldapEnabled: "啟用 LDAP 登入",
    ldapProviderName: "提供者名稱",
    ldapProviderNamePlaceholder: "例如 企業 Active Directory",
    ldapHost: "伺服器",
    ldapHostPlaceholder: "ldap.example.com",
    ldapPort: "連接埠",
    ldapBaseDn: "基準 DN",
    ldapBaseDnPlaceholder: "DC=corp,DC=example,DC=com",
    ldapUseTls: "使用 TLS (ldaps://)",
    ldapRequireServiceAccount: "使用服務帳戶",
    ldapRequireServiceAccountHint: "當使用者無法直接繫結時啟用（非 AD 環境）。先用服務帳戶查詢使用者 DN，再用使用者密碼重新繫結。",
    ldapServiceAccountDn: "服務帳戶 DN",
    ldapServiceAccountDnPlaceholder: "CN=svc,OU=Service,DC=corp,DC=com",
    ldapServiceAccountPassword: "服務帳戶密碼",
    ldapServiceAccountPasswordSet: "已儲存服務帳戶密碼，留空表示維持不變。",
    ldapSearchBase: "搜尋基準",
    ldapSearchBasePlaceholder: "留空時使用基準 DN",
    ldapSearchFilter: "搜尋篩選器",
    ldapSearchFilterPlaceholder: "(|(sAMAccountName={user})(userPrincipalName={user})(mail={user})(cn={user}))",
    ldapAllowedGroups: "允許登入的群組",
    ldapAllowedGroupsPlaceholder: "CN=DBA,OU=Groups,DC=corp,DC=com, dba-admins",
    ldapAllowedGroupsHint: "以逗號分隔的群組 DN 或群組名稱(DN 內逗號需寫成 \\,)。留空不限制;設定後僅群組成員可登入。",
    ldapTest: "測試",
    ldapSave: "儲存 LDAP 登入",
    ldapTestSuccess: "連線測試成功",
    ldapTestFailed: "連線測試失敗",
    ldapSaveSuccess: "LDAP 登入設定已儲存",
    ldapSaveFailed: "儲存 LDAP 登入設定失敗",
    ldapLoadFailed: "載入 LDAP 登入設定失敗",
  },
  toolbar: {
    moreActions: "更多操作",
    newConnection: "建立連線",
  ...
  connection: {
    ...
    ldapBaseDn: "基準 DN",
    authMethod: "驗證方式",
    ldapSecurityProtocol: "驗證",
    ldapSimple: "簡單繫結",
    ldapGssapi: "GSSAPI (Kerberos)",
    ldapNone: "無",
    ldapPrincipal: "Principal",
    ldapKeytabFile: "Keytab 檔案",
    ldapKeytabSelected: "已選擇 Keytab 檔案，密碼將用作備援。",
    ldapPasswordOptional: "密碼（使用 Keytab 時可選）",
    ldapPasswordRequired: "密碼",
    ldapKrb5Conf: "krb5.conf",
    ldapKrb5ConfPlaceholder: "[libdefaults]\n    default_realm = EXAMPLE.COM\n\n[realms]\n    EXAMPLE.COM = {\n        kdc = kdc.example.com:88\n    }",
    ldapKrb5ConfHint: "krb5.conf 格式的 Kerberos 設定。使用 GSSAPI 時必填。",
    ldapSearchFilter: "搜尋篩選器",
    principal: "Kerberos Principal",
    keytab: "Keytab 檔案",
    browse: "瀏覽",
    passwordOptionalForKeytab: "密碼（可選，僅用 Keytab 認證時留空）",
    passwordRequired: "密碼（必填）",
    krb5Conf: "krb5.conf",
    krb5ConfPlaceholder: "[libdefaults]\n    default_realm = EXAMPLE.COM\n\n[realms]\n    EXAMPLE.COM = {\n        kdc = kdc.example.com:88\n    }",
    krb5ConfHint: "在此貼上 krb5.conf 內容，將作為臨時檔案供本次連線使用。",
  ...
  editor: {
    ...
    contextMenu: {
      ...
      openLdapBrowser: "瀏覽 LDAP 目錄",
      openLdapSearch: "搜尋 LDAP",
    },
    search: {
      find: "尋找",
      replace: "取代",
  ...
  ldap: {
    ...
    verifyPasswordTooltip: "驗證密碼(一次性 bind)",
    verifyPasswordPlaceholder: "輸入要驗證的密碼",
    passwordVerified: "密碼驗證通過",
    passwordNotVerified: "密碼不正確",
    binaryReadonlyHint: "二進位值(base64),此編輯器暫不支援修改",
    showOperational: "切換 operational 屬性(createTimestamp、entryUUID 等)",
    objectClassEditorTitle: "編輯物件類別",
    ...
    removeValue: "移除值",
    editTitle: "編輯 LDAP 條目",
    renameTitle: "重新命名 LDAP 條目",
    currentDn: "目前 DN",
    newRdn: "新 RDN",
    newParentDn: "新父 DN",
    newParentDnHint: "可選,留空保持原父級",
    deleteTitle: "刪除 LDAP 條目",
